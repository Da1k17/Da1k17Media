...
const options ={
      renderNode: {
            ...
            [BLOCKS.EMBEDDED_ASSET]: node => (
                  <Img
                  fluid={useContentfulImage(node.data.target.fields.file["jp-JP"].url)}

                        alt={
                              node.data.target.fields.description
                              ? node.data.target.fields.description["jp-JP"]
                              : node.data.target.fields.title["jp-JP"]
                        }
                  />
            )
      },
                        ...
                        <div className="container">
                              ...
                              <div className="postbody">
                                          {/* {documentToReactComponents(
                                                data.contentfulBlogPost.content.raw,
                                                options
                                          )} */}
                              </div>
